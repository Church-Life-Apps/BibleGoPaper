...
\begin{tikzpicture}[
    ...
    block/.style={rectangle, draw=pipeline!40, fill=pipeline!8, text width=1.8cm, minimum height=0.8cm, align=center, font=\scriptsize\sffamily, rounded corners=2pt, line width=0.4pt},
    data/.style={rectangle, draw=tier1!40, fill=tier1!8, text width=1.8cm, minimum height=0.8cm, align=center, font=\scriptsize\sffamily, rounded corners=2pt, line width=0.4pt},
    output/.style={rectangle, draw=accent!40, fill=accent!8, text width=1.8cm, minimum height=0.8cm, align=center, font=\scriptsize\sffamily, rounded corners=2pt, line width=0.4pt},
...
% Tech labels
\node[techlabel, right=0.15cm of extract.east, anchor=west, xshift=1.8cm] {GPT-3.5};
\node[techlabel, right=0.15cm of retrieve.east, anchor=west] {HuggingFace};
\node[techlabel, right=0.15cm of generate.east, anchor=west, xshift=1.8cm] {GPT-3.5};
\node[techlabel, right=0.15cm of score.east, anchor=west] {USE + textstat};
\node[techlabel, right=0.15cm of footnote.east, anchor=west] {Cross-encoder};

% Arrows - to deployment
\draw[arrow] (footnote.south) -- (db.north);
\draw[arrow] (db) -- (webapp);

% Background groups
\begin{scope}[on background layer]
    \node[fit=(bible)(comm), fill=tier1!5, draw=none, rounded corners=4pt, inner sep=6pt] {};
    \node[fit=(extract)(retrieve)(generate)(score)(footnote), fill=pipeline!5, draw=none, rounded corners=4pt, inner sep=6pt] {};
