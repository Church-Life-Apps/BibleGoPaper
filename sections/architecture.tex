...
% Tech labels - placed below each box to avoid overlap
\node[techlabel, below=0.08cm of extract] {GPT-3.5};
\node[techlabel, below=0.08cm of retrieve] {HuggingFace};
\node[techlabel, below=0.08cm of generate] {GPT-3.5};
\node[techlabel, below=0.08cm of score] {USE + textstat};
\node[techlabel, below=0.08cm of footnote] {Cross-encoder};
