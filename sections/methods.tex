...
% =================== ARROWS ===================
% NT lane: straight down into shared quote extraction
\draw[arrow] (nt.south) -- ++(0,-0.4) -| (qe.north);
% OT lane: through retrieval, then merge into shared quote extraction
\draw[arrow] (ot) -- (retrieval);
\draw[arrow] (retrieval.south) -- ++(0,-0.4) -| (qe.north);
% Shared pipeline
\draw[arrow] (qe) -- (group);
